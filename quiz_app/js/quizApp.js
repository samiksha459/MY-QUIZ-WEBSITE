...
//function to display loading game info. this function will display user name and show some loading dialogue for interactive value.
    function loadingGameIntro () {
        var loadInterval = setInterval (function () {
            document.getElementById ('player-name').innerHTML = 'Starting up the QUIZ...';
            document.getElementById ('adding-elements').innerHTML = usrName + ', good luck to you and hold on a sec while the app finishes...';
            ++counter;
            switch (counter) {
                case 1:
                    document.getElementById ('music-questions').innerHTML = "loading the questions.";
                    break;
                case 2:
                    document.getElementById ('music-questions').style.display = 'none';
                    document.getElementById ('genres').innerHTML = "...loading.";
                    break;
                case 3:
                ...
                case 4:
                    ...
                    document.getElementById ('artists').innerHTML = "...loading.";
                    break;
                case 5:
                    document.getElementById ('artists').style.display = 'none';
                    document.getElementById ('musical-instruments').innerHTML = "...loading.";
                    ...
                    document.getElementById ('starting').innerHTML = "Ok...Quiz is starting now...good luck!";
                    break;
                case 6:
